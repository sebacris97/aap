...
class Perceptron(object):
    ...
    """
    def __init__(self, alpha=0.01, n_iter=50, random_state=None, draw=0, title=['X1','X2'],show_ite=False):
        self.alpha = alpha
        self.n_iter = n_iter
    ...
    def fit(self, X, y):
        ...
        while ((i<self.n_iter) and (errors > 0.0)):
            ...
            i = i + 1
        print("pesos de w: ",self.w_)
        print("pesos de b: ",self.b_)
        if self.show_ite=='LAST':
            print(i)
        return self
